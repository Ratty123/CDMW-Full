...
def build_controls_panel(tab: object) -> QWidget:
    ...
    tab.use_in_new_item_studio_button = QPushButton("Use in New Item Studio")
    tab.use_in_new_item_studio_button.setToolTip("Open this resolved model in New Item Studio's model step.")
    ...
    tab.download_import_button = tab.more_actions_menu.addAction("Download + New Item Studio")
