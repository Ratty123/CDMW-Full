...
NEW_ITEM_STUDIO_SECTION = {
    ...
    <ul>
      ...
      <li><b>Kampfwerte und Preise</b>: Das Raster zeigt rohe ItemInfo-Werte, keine nachweislich im Spiel angezeigte Schadenszahl. Wähle eine Zelle, um sie mit der Vorlage und dem Bereich der spielinternen Ausrüstung zu vergleichen. Preise sind getrennt gekennzeichnet; beliebige Werte, exakte Rohwerte, zusätzliche Stufen und eigene Aufwertungszeilen liegen unter <b>Erweitert / experimentell</b>.</li>
      <li><b>Fähigkeiten und Waffenaussehen</b>: Gameplay-Vorteile sind die im Gegenstand eingebauten Abyss-Gear-Sockelgegenstände. Behalte die Liste der Vorlage oder passe sie an; vier ist die belegte Voreinstellung, fünf bis acht erfordern eine ausdrückliche experimentelle Freigabe. Waffeneffekte sind nur visuell und fügen weder Angriffsschaden noch Elementarstatus hinzu. Wähle zuerst einen kuratierten Effekt; rohe Effektdateien, numerische Platzierung, Umfärbung und Partikeleinstellungen liegen unter <b>Erweitert</b>, und angepasste Effekte bleiben im Spiel unbewiesen. Rüstung und Zubehör bieten diesen Waffen-Prefab-Pfad nicht an.</li>
