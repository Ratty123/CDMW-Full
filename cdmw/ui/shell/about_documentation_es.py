...
NEW_ITEM_STUDIO_SECTION = {
    ...
    <ul>
      ...
      <li><b>Estadísticas de combate y precios</b>: la cuadrícula muestra valores ItemInfo sin procesar, no una cifra de daño visible para el jugador que esté demostrada. Selecciona una celda para compararla con la plantilla y con el intervalo usado por el equipo propio del juego. Los precios están identificados por separado; las estadísticas arbitrarias, los valores exactos, los niveles adicionales y las filas de mejora propias están bajo <b>Avanzado / experimental</b>.</li>
      <li><b>Habilidades y apariencia del arma</b>: las ventajas de juego son los objetos de engarce Abyss Gear integrados en el objeto. Conserva la lista de la plantilla o personalízala; cuatro es el valor predeterminado respaldado por pruebas, y de cinco a ocho requiere activar expresamente la opción experimental. Los efectos de arma son solo visuales y no añaden daño de ataque ni estados elementales. Elige primero un efecto visual seleccionado; los archivos de efectos sin procesar, la colocación numérica, el cambio de color y el ajuste de partículas están bajo <b>Avanzado</b>, y los aspectos personalizados siguen sin probarse en el juego. Las armaduras y los accesorios no ofrecen esta ruta de efecto para prefabs de arma.</li>
