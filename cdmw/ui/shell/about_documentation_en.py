...
NEW_ITEM_STUDIO_SECTION = {
    ...
    <ul>
      ...
      <li><b>Perks &amp; Effects</b>: gameplay perks are the Abyss Gear socket items built into the item. Keep the template list or customize it; four is the evidence-backed default, and five to eight requires an explicit experimental option. Weapon effects are visual only and do not add attack damage or elemental status. Choose a curated visual first; raw effect files, numeric placement, recolouring and particle tuning stay under <b>Advanced</b>, and customized looks remain unproven in game. Armour and accessories do not offer this weapon-prefab effect path.</li>
