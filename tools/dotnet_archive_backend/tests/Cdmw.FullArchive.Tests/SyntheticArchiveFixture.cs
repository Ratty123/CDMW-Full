...
internal sealed class SyntheticArchiveFixture : IAsyncDisposable
{
    ...
    public static async Task<SyntheticArchiveFixture> CreateAssociatedAssetsAsync()
    {
        ...
        var payloads = new (string Path, byte[] Bytes)[]
        {
            ...
            ("character/model/1_pc/9_pgm/head/head/cd_pgm_00_head_00_0004.pac", Encoding.ASCII.GetBytes("PAC shared rig head")),
            ("character/prefab/1_pc/09_pgm/head/head/cd_pgm_00_head_00_0004.prefabdata_xml",
                Encoding.UTF8.GetBytes("<HeadPrefabData><MorphTargetSet FileName=\"1_pc/1_phm/phm_01.pamt\"/></HeadPrefabData>")),
            ("character/model/1_pc/1_phm/phm_01.pamt", Encoding.ASCII.GetBytes("PAMT male synthetic")),
