...
internal sealed class UiLocalizationOwner : IDisposable
{
    ...
    // BEGIN GENERATED UI LOCALIZATION KEYS
        ...
        "Background",
        "Bake",
        "Bake keeps this result in the mesh; Reset All discards it. Topology edits stay blocked until one of them runs.",
        ...
        "Choose Part Colour",
        "Choose Part Tint",
        "Choose a definition profile above, or Author Slider... to build another one.",
        ...
        "My Preset",
        "New Slider",
        "No definition profile yet. Author Slider... builds one from this mesh; nothing is changed until you Bake.",
        "No edit actions yet",
        "None",
        "Off",
        "Orbit",
        ...
        "Pick a profile, shape with the sliders, then Bake to keep the result. Sliders are non-destructive until baked.",
        "Pinch",
        "Placement",
        ...
        "Step 1: Definition profile",
        "Step 2: Shape sliders",
        "Step 3: Garment refit (optional)",
        "Step 4: Keep the result",
        "Strength",
        "Strict mirror",
        "Subdivide",
        ...
        "This profile carries no sliders yet. Author Slider... adds one to it.",
        "Tint...",
        "Tool: {value_0}",
        "Top",
        "Topology",
        ...
        "Wheel",
        "Whole-part selection: drag shape, combine mode and X-Ray.",
        "Wire",
        "Wire px",
