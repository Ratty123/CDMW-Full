...
internal sealed class UiLocalizationOwner : IDisposable
{
    ...
    // BEGIN GENERATED UI LOCALIZATION KEYS
        ...
        "Next",
        "No edit actions yet",
        "No parts selected. Return to the viewport, select one or more parts, then refresh.",
        ...
        "Refresh from viewport selection",
        ...
        "Select",
        "Select All",
        "Select at least one part and refresh the selection.",
