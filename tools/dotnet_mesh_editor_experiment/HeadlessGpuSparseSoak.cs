...
internal static partial class HeadlessGpuSparseSoak
{
    ...
    private static (Dictionary<string, object?> Report, bool Ok) ExecuteWithNoVsync(HeadlessGpuSparseSoakOptions options)
    {
        ...
        AddCameraAndFitOverlayGates(gates, cameraZoomProof, fitRelativeOverlayProof);
    ...
    private static void AddCameraAndFitOverlayGates(
        Dictionary<string, bool> gates,
        Dictionary<string, object?> cameraZoomProof,
        Dictionary<string, object?> fitRelativeOverlayProof)
    {
