...
.\.venv\Scripts\python.exe -m pytest tests/test_paa_motion_encode.py tests/test_paloc_format.py tests/test_papr_format.py tests/test_posemodifier_xml.py -m real_game
