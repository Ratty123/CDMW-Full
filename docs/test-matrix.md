...
.\.venv\Scripts\python.exe -m pytest tests/test_projectile_package.py
.\.venv\Scripts\python.exe -m pytest tests/test_placement_studio_rig_files.py tests/test_placement_studio_rig_key.py tests/test_placement_studio_table_columns.py tests/test_placement_studio_what_is_this.py
.\.venv\Scripts\python.exe -m pytest tests/test_placement_studio_open_caches.py
.\.venv\Scripts\python.exe -m pytest tests/test_translation_studio.py tests/test_format_explorer.py
.\.venv\Scripts\python.exe -m pytest tests/test_prefab_binary.py tests/test_prefab_binary_edit.py tests/test_prefab_array_edit.py tests/test_prefab_rewriter_fuzz.py tests/test_prefab_values.py tests/test_prefab_glossary.py tests/test_prefab_companions.py tests/test_prefab_asset_catalog.py tests/test_prefab_inspector_dialog.py tests/test_prefab_inspector_structure.py
...
.\.venv\Scripts\python.exe -m pytest tests/test_paa_motion_encode.py tests/test_paloc_format.py tests/test_papr_format.py tests/test_papr_block.py tests/test_posemodifier_xml.py tests/test_projectile_package.py tests/test_translation_studio.py -m real_game
...
.\.venv\Scripts\python.exe -m pytest tests/test_mesh_topology_provenance.py tests/test_native_mesh_topology_provenance.py tests/test_mesh_pac_topology_serializer.py
...
when a rebuild is blocked. Run all three after any change to the topology
contract, the native session provenance, or the PAC LOD0 writer.
